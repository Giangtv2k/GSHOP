...
public class changPasswordController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(!u.checkAccountPassword()){
                request.setAttribute("message", "Password failse!");
            }
            else if(!newpass.equals(repass)){
                request.setAttribute("message", "New Password need equals Re-password!");
            }
            else{
                User u1 = new User();
                u1.UpdatePass(newpass, account);
